...
ACLOCAL = ${SHELL} /root/libevent-2.0.22-stable/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /root/libevent-2.0.22-stable/missing --run autoconf
AUTOHEADER = ${SHELL} /root/libevent-2.0.22-stable/missing --run autoheader
AUTOMAKE = ${SHELL} /root/libevent-2.0.22-stable/missing --run automake-1.12
AWK = gawk
CC = gcc
...
LD = /opt/rh/devtoolset-11/root/usr/libexec/gcc/x86_64-redhat-linux/11/ld -m elf_x86_64
LDFLAGS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/libevent-2.0.22-stable/missing --run makeinfo
MANIFEST_TOOL = :
...
ZLIB_LIBS = -lz 
abs_builddir = /root/libevent-2.0.22-stable
abs_srcdir = /root/libevent-2.0.22-stable
abs_top_builddir = /root/libevent-2.0.22-stable
abs_top_srcdir = /root/libevent-2.0.22-stable
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
install_sh = ${SHELL} /root/libevent-2.0.22-stable/install-sh
